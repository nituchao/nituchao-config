...
(setq default-mode-line-format 
      (list
       ...
       ;; buffer formate for DOS or UNIX
       "["
       '(:eval (propertize "%Z" 'face 'font-lock-constant-face
			   'help-echo buffer-file-coding-system))
       "] "
       ...
       "["
       '(:eval (propertize (format-time-string "%Y-%m-%d %H:%M")
			   'help-echo
			   (concat (format-time-string "%c; ")
				   (emacs-uptime "Uptime:%S"))))
       "] "
       
       ;; show file 'default-directory
       " ["
       "%f"
       "]"
